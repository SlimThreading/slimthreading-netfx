...
namespace TestShared {
    internal class TestReentrantReadWriteLock {
        ...
        //
        // The reentrant read write lock and the recursive acquisition count.
        //

        private static StReentrantReadWriteLock rwl = new StReentrantReadWriteLock(100);
        private const int REENTER = 10;
